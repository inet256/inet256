...
func (d *Daemon) runAutoPeeringServices(ctx context.Context, localID inet256.Addr, srvs []autopeering.Service, peerStores []peers.Store[mesh256.TransportAddr], addrSource autopeering.AddrSource) {
